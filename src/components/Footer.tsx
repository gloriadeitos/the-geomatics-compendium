    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-6">
              <FontAwesomeIcon icon={faGlobe} className="text-blue-400 text-2xl mr-2" />
              <span className="text-xl font-bold">The Geomatics Compendium</span>
            </div>
            <p className="text-gray-400 mb-6">
              O compêndio completo para profissionais e estudantes de geomática.
            </p>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-6">Inscreva-se</h3>
            <p className="text-gray-400 mb-4">Receba nossas atualizações e novidades.</p>
            <form className="flex">
              <input 
                type="email" 
                placeholder="Seu e-mail" 
                className="px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800 w-full"
              />
              <button 
                type="submit"
                className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-r-md text-white"
              >
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2023 The Geomatics Compendium. Todos os direitos reservados.</p>
